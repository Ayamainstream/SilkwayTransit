...
public class DriversPlanLVAdapter extends ArrayAdapter<StationTime> {

    public DriversPlanLVAdapter(@NonNull Context context, ArrayList<StationTime> dataModalArrayList) {
...
//        TextView status = listitemView.findViewById(R.id.expected_time_header);
